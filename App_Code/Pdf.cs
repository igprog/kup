...
Visinu tražene pozajmice odobrio je UPRAVNI ODBOR KUP-a na svojoj sjednici od ______________ u iznosu od {0}.", g.Currency(loan.loan)), GetFont(9, Font.ITALIC)));
    ...
    [WebMethod]
    public string AllCards(List<User.NewUser> users, string buisinessUnitCode, int year) {
        try {
            string path = Server.MapPath("~/upload/pdf/temp/cards/");
            g.DeleteFolder(path);
            g.CreateFolder(path);

            User U = new User();
            User.NewUser user = new User.NewUser();
            PrintDoc pd = new PrintDoc();
            Document doc = new Document();

            foreach (User.NewUser user_ in users) {
                user = U.GetUserData(user_.id, year);
            ...
            string zipFileName = string.Format("KarticeKorisnika{0}_{1}"
                , string.IsNullOrEmpty(buisinessUnitCode) ? "" : string.Format("_{0}", buisinessUnitCode)
                , year);
            pd.fileName = g.Zip(zipFileName);
    ...
    public string Repayment(int month, int year, string buisinessUnitCode, Account.Accounts records) {
        try {
            ...
            foreach (Account.NewAccount x in records.data) {
                ...
                cell1.Border = 0;
                table.AddCell(cell1);
                PdfPCell cell2 = new PdfPCell(new Phrase(string.Format("{0} {1} {2}", x.user.lastName, x.user.firstName, x.user.isActive == 1 ? "" : "(Neaktivan)"), GetFont(x.user.isActive==1?9:7)));
                cell2.Border = 0;
                table.AddCell(cell2);
                PdfPCell cell3 = new PdfPCell(new Phrase(g.Format(x.repayment), GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                cell3.Border = 0;
                table.AddCell(cell3);
                PdfPCell cell4 = new PdfPCell(new Phrase(g.Format(x.currRepayment), GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                cell4.Border = 0;
                table.AddCell(cell4);
...
_____________
{2}"
                            , g.Format(records.total.currRepayment), g.Format(records.total.userRepayment), g.Format(records.total.repaymentTotal))
                            , GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
            table.AddCell(new PdfPCell(new Phrase(g.Format(records.total.restToRepayment), GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
    ...
    public string MonthlyFee(int month, int year, string buisinessUnitCode, Account.Accounts records) {
        try {
            ...
            table.AddCell(new PdfPCell(new Phrase("", GetFont())) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15 });
            table.AddCell(new PdfPCell(new Phrase("Ukupno:", GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
            table.AddCell(new PdfPCell(new Phrase(g.Format(records.total.userPaymentWithMonthlyFee), GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
            table.AddCell(new PdfPCell(new Phrase("", GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
            doc.Add(table);
    ...
    public string MonthlyPayment(int month, int year, Account.MonthlyPayment records) {
        try {
            ...
            if (records.terminationWithdraw.data.Count > 0) {
                ...
                table.AddCell(new PdfPCell(new Phrase("Mat br.", GetFont())) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15 });
                table.AddCell(new PdfPCell(new Phrase("Korisnik", GetFont())) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15 });
                table.AddCell(new PdfPCell(new Phrase("Uplačeni ulog", GetFont())) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
                ...
                table.WidthPercentage = 100f;
                table.SetWidths(new float[] { 0.5f, 2f, 1f, 1f, 1f, 1f, 1f });
                foreach (var x in records.terminationWithdraw.data) {
                    PdfPCell cell1 = new PdfPCell(new Phrase(string.Format("{0}", x.user.id), GetFont()));
                    cell1.Border = 0;
                    table.AddCell(cell1);
                    PdfPCell cell2 = new PdfPCell(new Phrase(string.Format("{0} {1}", x.user.firstName, x.user.lastName), GetFont()));
                    cell2.Border = 0;
                    table.AddCell(cell2);
                    PdfPCell cell3 = new PdfPCell(new Phrase(g.Format(x.userPayment), GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                    cell3.Border = 0;
                    table.AddCell(cell3);
                    PdfPCell cell4 = new PdfPCell(new Phrase("", GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                    cell4.Border = 0;
                    table.AddCell(cell4);
                    PdfPCell cell5 = new PdfPCell(new Phrase(g.Format(x.userPayment), GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                    cell5.Border = 0;
                    table.AddCell(cell5);
                    PdfPCell cell6 = new PdfPCell(new Phrase(g.Format(x.debt), GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                    cell6.Border = 0;
                    table.AddCell(cell6);
                    PdfPCell cell7 = new PdfPCell(new Phrase(g.Format(x.terminationWithdraw), GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                    cell7.Border = 0;
                    table.AddCell(cell7);
                }
                doc.Add(table);
                ...
                table.AddCell(new PdfPCell(new Phrase("", GetFont())) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15 });
                table.AddCell(new PdfPCell(new Phrase("Ukupno:", GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
                table.AddCell(new PdfPCell(new Phrase(g.Currency(records.terminationWithdraw.total.userPayment), GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
                table.AddCell(new PdfPCell(new Phrase("", GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
                table.AddCell(new PdfPCell(new Phrase(g.Currency(records.terminationWithdraw.total.userPayment), GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
                table.AddCell(new PdfPCell(new Phrase(g.Currency(records.terminationWithdraw.total.debt), GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
                table.AddCell(new PdfPCell(new Phrase(g.Currency(records.terminationWithdraw.total.terminationWithdraw), GetFont(true))) { Border = PdfPCell.BOTTOM_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 15, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
                doc.Add(table);
            }
...
"), GetFont(8))) { Border = PdfPCell.BOX, Padding = 2, MinimumHeight = 40, HorizontalAlignment = Element.ALIGN_LEFT });
    ...
    public string Recapitulation(int month, Account.RecapYearlyTotal records, string title) {
        try {
            ...
            table.AddCell(new PdfPCell(new Phrase(string.Format("{0:N}", records.total.accountBalance), GetFont(true))) { Border = PdfPCell.TOP_BORDER, Padding = 2, MinimumHeight = 30, PaddingTop = 5, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
    ...
    public void CreateCard(Document doc, User.NewUser user, int year) {
        ...
        float[] cellWidths = { 0.7f, 0.7f, 1.2f, 1f, 1.1f, 0.9f, 1f, 1.1f, 0.9f };
        int colNo = cellWidths.Length;
        ...
        table.AddCell(new PdfPCell(new Phrase("Ulog", GetFont())) { Border = PdfPCell.BOTTOM_BORDER, Padding = 5, MinimumHeight = 20 });
        table.AddCell(new PdfPCell(new Phrase("", GetFont())) { Border = PdfPCell.BOTTOM_BORDER, Padding = 5, MinimumHeight = 20 });
        table.AddCell(new PdfPCell(new Phrase("", GetFont())) { Border = PdfPCell.BOTTOM_BORDER | PdfPCell.LEFT_BORDER, Padding = 5, MinimumHeight = 20 });
        table.AddCell(new PdfPCell(new Phrase("Pozajmica", GetFont())) { Border = PdfPCell.BOTTOM_BORDER, Padding = 5, MinimumHeight = 20 });
        table.AddCell(new PdfPCell(new Phrase("", GetFont())) { Border = PdfPCell.BOTTOM_BORDER, Padding = 5, MinimumHeight = 20 });
        doc.Add(table);

        table = new PdfPTable(colNo);
        table.WidthPercentage = 100f;
        table.SetWidths(cellWidths);
        ...
        table.AddCell(new PdfPCell(new Phrase(string.Format("Saldo ({0})", s.Data().currency), GetFont())) { Border = PdfPCell.BOTTOM_BORDER, Padding = 5, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
        ...
        foreach (Account.NewAccount x in user.records) {
            if (x.lastDayInMonth != "01.01") {
                ...
                cell3.Border = 0;
                table.AddCell(cell3);
                PdfPCell cell4 = new PdfPCell(new Phrase(x.recordType == g.terminationWithdraw || x.recordType == g.terminationRepayment ? string.Format("{0:N}", x.amount) : "", GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                cell4.Border = 0;
                table.AddCell(cell4);
                ...
                cell5.Border = 0;
                table.AddCell(cell5);
                PdfPCell cell5_ = new PdfPCell(new Phrase("", GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                cell5_.Border = 0;
                table.AddCell(cell5_);
                ...
                //cell6.Border = 0;
                table.AddCell(cell6);
                PdfPCell cell7 = new PdfPCell(new Phrase(x.recordType == g.repayment || x.recordType == g.userRepayment || x.recordType == g.manipulativeCosts || x.recordType == g.loan || x.recordType== g.terminationRepayment ? string.Format("{0:N}", x.amount) : "", GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                cell7.Border = 0;
                table.AddCell(cell7);
                PdfPCell cell8 = new PdfPCell(new Phrase("", GetFont())) { Padding = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT };
                cell8.Border = 0;
        ...
        table.AddCell(new PdfPCell(new Phrase(g.Format(user.total.terminationWithdrawWithTerminationRepayment), GetFont(true))) { Border = PdfPCell.TOP_BORDER | PdfCell.BOTTOM_BORDER, Padding = 5, MinimumHeight = 20, PaddingTop = 5, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
        ...
        table.AddCell(new PdfPCell(new Phrase(g.Format(user.total.userPaymentBalance), GetFont(true))) { Border = PdfPCell.TOP_BORDER | PdfCell.BOTTOM_BORDER, Padding = 5, MinimumHeight = 20, PaddingTop = 5, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
        ...
        table.AddCell(new PdfPCell(new Phrase(g.Format(user.total.totalObligation), GetFont(true))) { Border = PdfPCell.TOP_BORDER | PdfCell.BOTTOM_BORDER, Padding = 5, MinimumHeight = 20, PaddingTop = 5, HorizontalAlignment = PdfPCell.ALIGN_RIGHT });
        doc.Add(table);
    ...
    private void AppendHeader(Document doc) {
        ...
        if (File.Exists(logoPath)) {
            ...
            table.AddCell(new PdfPCell(new Phrase(s.Data().printSettings.headerInfo, GetFont())) { Border = PdfPCell.NO_BORDER, Padding = 2, MinimumHeight = 15, PaddingBottom = 10, HorizontalAlignment = PdfCell.ALIGN_RIGHT });
        } else {
